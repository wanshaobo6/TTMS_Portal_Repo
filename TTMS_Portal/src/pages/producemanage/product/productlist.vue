      ...
      <el-main><div class="top">
        ...
        <div class="firstRow">
          <el-row :gutter="20">
            ...
            <el-col :span="3"><div class="grid-content "><el-select v-model="FirstClassify" placeholder="一级分类">
              <el-option
            ...
            <el-col :span="3"><div class="grid-content "><el-select v-model="SecondClassify" placeholder="二级分类">
              <el-option
            ...
            <el-col :span="3"><div class="grid-content "><el-select v-model="ThridClassify" placeholder="三级分类">
              <el-option
    ...
    methods: {
      ...
      loadData() {
        ...
        this.$http.get("/producemanage/product/productlist/page", {
          params: {
            status:this.status,
            productCatId1:this.FirstClassify,
            productCatId2:this. SecondClassify,
            productCatId3:this.ThridClassify,
            projectName:this.input2,
            productNumber:this.input3,
            productName:this.name,
            serverStartTime:this.StartTime,
            serverEndtTime:this.EndtTime,
